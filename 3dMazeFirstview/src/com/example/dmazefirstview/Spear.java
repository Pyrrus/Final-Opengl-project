package com.example.dmazefirstview;
...
public class Spear {
	...
	public Spear(float size) {
		...
		float[] vertices2 = { // 5 vertices of the pyramid in (x,y,z)
				-1.0f / size, 4.0f / size, -1.0f / size, // 0. left-bottom-back
						1.0f / size, 4.0f / size, -1.0f / size, // 1. right-bottom-back
						1.0f / size, 4.0f / size, 1.0f / size, // 2. right-bottom-front
						-1.0f / size, 4.0f / size, 1.0f / size, // 3. left-bottom-front
						0.0f, 8.0f / size, 0.0f // 4. top
				};
		 vertices = vertices2;
